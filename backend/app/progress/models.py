...
class AttendanceExcusalRequest(Base):
    """Guardian-submitted request to excuse a learner for a class session; staff may approve or deny."""

    __tablename__ = "attendance_excusal_requests"
